...
fundamental σ₁ σ₂ (val (`true/ 𝓁)) σ₁≈σ₂ ⇓-val ⇓-val _ = refl
...
noninterference : ∀ {tᵢₙ tₒᵤₜ 𝓁ᵢₙ 𝓁ₒᵤₜ ζ} {M : ∅ , tᵢₙ / 𝓁ᵢₙ ⊢ₑ tₒᵤₜ / 𝓁ₒᵤₜ} {V₁ V₂ : ∅ ⊢ᵥ tᵢₙ / 𝓁ᵢₙ}
  → ¬ 𝓁ᵢₙ  ⊑ ζ
  →   𝓁ₒᵤₜ ⊑ ζ
    --------------------------------------------------------
...
-- Example:
noninterference-example : ∀ {t} {M : ∅ , t / 𝐻 ⊢ₑ `𝔹 / 𝐿 } {V₁ V₂ : ∅ ⊢ᵥ t / 𝐻} {V₁′ V₂′ : ∅ ⊢ᵥ `𝔹 / 𝐿}
  → (M [ (val V₁) ]) ⇓ V₁′ -- input V₁ ⇒ output V₁′
  → (M [ (val V₂) ]) ⇓ V₂′ -- input V₂ ⇒ output V₂′
  → V₁′ ≡ V₂′              -- then they are the same 𝔹
noninterference-example {t} {M} {V₁} {V₂} {V₁′} {V₂′} =
  let ¬𝐻⊑𝐿 = λ {(⊑-l ())} in
  let noninterf = noninterference {t} {`𝔹} {𝐻} {𝐿} {𝐿} {M} {V₁} {V₂} ¬𝐻⊑𝐿 ⊑-refl in
