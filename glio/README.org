...
+ [[./Consistency.agda][Consistency]] defines consistency relations (=~=) between information flow labels and types. It also proves that <img src="https://render.githubusercontent.com/render/math?math=S \sim T \iff S \lesssim T \wedge T \lesssim S">.
